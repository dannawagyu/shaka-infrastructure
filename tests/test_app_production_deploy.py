...
class AppProductionDeployTest(unittest.TestCase):
    def test_workflow_is_infra_owned_and_uses_single_production_environment(self):
        ...
        self.assertIn("SHAKA_FLYWAY_CLI_URL: ${{ vars.SHAKA_FLYWAY_CLI_URL }}", text)
        self.assertIn("SHAKA_FLYWAY_CLI_SHA256: ${{ vars.SHAKA_FLYWAY_CLI_SHA256 }}", text)
        self.assertIn("SHAKA_MYSQL_CONNECTOR_J_URL: ${{ vars.SHAKA_MYSQL_CONNECTOR_J_URL }}", text)
        self.assertIn("SHAKA_MYSQL_CONNECTOR_J_SHA256: ${{ vars.SHAKA_MYSQL_CONNECTOR_J_SHA256 }}", text)
    ...
    def test_database_migration_script_fails_closed_and_uses_ssh_tunnel(self):
        ...
        self.assertIn("SHAKA_FLYWAY_CLI_URL", text)
        self.assertIn("SHAKA_FLYWAY_CLI_SHA256", text)
        self.assertIn("SHAKA_MYSQL_CONNECTOR_J_URL", text)
        self.assertIn("SHAKA_MYSQL_CONNECTOR_J_SHA256", text)
